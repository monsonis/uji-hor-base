...
Ext.onReady(function()
{
    ...
    var eventStore = Ext.create('Extensible.calendar.data.EventStore',
    {
        ...
        // It's easy to provide generic CRUD messaging without having to handle events on every
        // individual view.
        // Note that while the store provides individual add, update and remove events, those fire
        // BEFORE the
        // remote transaction returns from the server -- they only signify that records were added
        // to the store,
        // NOT that your changes were actually persisted correctly in the back end. The 'write'
        // event is the best
